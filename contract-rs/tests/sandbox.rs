...
) -> Result<(near_workspaces::Account, near_workspaces::Contract), Box<dyn std::error::Error>> {
...
async fn test_can_be_incremented() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let counter_in_zero = contract.view("get_num").args_json(json!({})).await?;
    ...
    let counter_in_one = contract.view("get_num").args_json(json!({})).await?;
...
async fn test_can_be_decremented() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let counter_in_minus_one = contract.view("get_num").args_json(json!({})).await?;
...
async fn test_can_be_reset() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let counter_reset = contract.view("get_num").args_json(json!({})).await?;
